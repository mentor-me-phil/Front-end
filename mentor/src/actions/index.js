...
export const login = user => dispatch => {
  ...
  axios
    .post("https://bw-mentor-me.herokuapp.com/api/login", user)
    .then(response => {
...
export const register = creds => dispatch => {
  ...
  axios
    .post("https://bw-mentor-me.herokuapp.com/api/register", creds)
    .then(response => {
...
export const GET_QID_START = "GET_QID_START";
export const GET_QID_SUCCESS = "GET_QID_SUCCESS";
export const GET_QID_FAIL = "GET_QID_FAIL";

export const getQuestionsID = id => dispatch => {
  dispatch = ({ type: GET_QID_START });
  axios
    .get(`https://bw-mentor-me.herokuapp.com/api/answers/${id}`)
    .then(response => {
      dispatch = ({ type: GET_QID_SUCCESS, payload: response.data });
    })
    .catch(error => {
      console.log(error);
      dispatch = ({ type: GET_QID_FAIL, payload: error });
    });
};
